...
const Navigation = ({ onScrolled }) => {
  ...
  const hoverColorClass = "hover:text-secondary-600";
  ...
  return (
    <NavigationMenu className="max-w-6xl mx-auto hidden lg:block">
      <NavigationMenuList className="gap-6">
        <NavigationMenuItem>
          <NavigationMenuTrigger
            className={`text-lg text-white font-semibold ${textColorClass} ${hoverColorClass}`}
          >
            OUR MENU
          </NavigationMenuTrigger>
          <NavigationMenuContent>
                ...
                {menuItems.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      <h3 className="text-base font-medium text-slate-900 group-hover:text-secondary-600 transition-colors">
                        {item.title}
                      </h3>
        ...
        {[
          ...
          <NavigationMenuItem key={item.to}>
            <NavigationMenuLink
              className={`text-lg font-semibold p-2 transition-colors ${textColorClass} ${hoverColorClass}`}
            >
