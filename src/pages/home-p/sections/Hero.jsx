  ...
  return (
    ...
    >
            ...
            <div className="absolute inset-0">
              <div className="max-w-7xl mx-auto px-4 h-full flex items-center justify-center lg:pt-20">
                <div className="text-white text-center">
                  <h1 className="font-bebas text-[46px] tracking-wider md:text-8xl font-extrabold mb-8 whitespace-pre-line">
                    {slide.title}
                  </h1>
                  ...
                  <Button
                    className="font-bebas tracking-wider bg-primary-600 rounded-[4px] text-white px-14 py-6 md:py-7 text-xl font-semibold uppercase
      ...
      <div className="opacity-0 hover:opacity-100 md:opacity-100 absolute left-8 right-8 top-1/2 flex justify-between -translate-y-1/2">
        <button
          onClick={scrollPrev}
          className="bg-black/30 hover:bg-primary-600 text-white w-11 h-11 md:w-16 md:h-16 flex items-center justify-center
